...
st.markdown('This application is meant to **_assist_ _banks_ _in_giving_ _loans_ to clients**, if a client **_will repay loan on time or not__* based on certain factors ')
